...
const Win: React.FC<Props> = ({ setContinue, prizeNumber, doubleAction }) => {
  ...
  const { lottery, setLottery, lotteryBalance } = useFlappyBirdContext();
          ...
          <>
            <div className='flex flex-col justify-between items-center' style={{ width: "100%", height: "100%" }}>
              ...
              <div className='flex flex-col'>
                <p style={{ color: "white", fontSize: "36px" }}>You won {lottery === 1 ? lotteryBalance : lotteryBalance * 2} CNTP!</p>
