...
const Win: React.FC<Props> = ({ setContinue }) => {
  return (
    <div className='flex flex-col justify-center items-center' style={{ height: "100%" }}>
      ...
      <button style={{ fontSize: "32px", width: "230px", height: "52px", marginBottom: "16px", borderRadius: "16px", border: 0, backgroundImage: "linear-gradient(to right, #D775FF , #8DA8FF)" }} onClick={() => setContinue("double")}>Spin to double</button>
